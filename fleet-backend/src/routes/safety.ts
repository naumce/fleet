...
safetyRouter.post("/panic", validateBody(locationSchema), asyncRoute(async (req, res) => {
...
safetyRouter.post("/emergency", validateBody(emergencySchema), asyncRoute(async (req, res) => {
...
safetyRouter.post("/fuel", validateBody(fuelSchema), asyncRoute(async (req, res) => {
