...
navigationRouter.post("/route", validateBody(routeSchema), asyncRoute(async (req, res) => {
...
navigationRouter.post("/incident", validateBody(incidentSchema), asyncRoute(async (req, res) => {
